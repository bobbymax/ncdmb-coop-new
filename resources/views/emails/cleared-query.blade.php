...
<link href="https://fonts.googleapis.com/css2?family=Lato:wght@100;300;400;700;900&display=swap" rel="stylesheet">
	<title>BATCH PAYMENT QUERY CLEARED!!</title>
		...
		<div class="row">
			...
			<div class="messageBody">
				<div class="salutation">
					...
					<h2>BATCH PAYMENT QUERY CLEARED!!</h2>
				</div>

				<div class="body">
					<p>THE QUERY ON BATCH PAYMENT WITH CODE {{ $batch->batchCode }} HAS NOW BEEN CLEARED {{ now() }}</p>
				</div>
